...
<section class="checkout-section">
            <div class="container">
                <form action="{{url('/store-order')}}" method="post" class="form-group billing-address-form" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mt-3">
                                            <div style="background: lightgrey;padding: 10px;margin-bottom: 10px;">
                                                <input type="radio" id="inside_dhaka" onclick="insideDhakaCharge()" name="charge" value="80" required/>
                                            ...
                                            <div style="background: lightgrey;padding: 10px;">
                                                <input type="radio" id="outside_dhaka" onclick="outsideDhakaCharge()" name="charge" value="150" required/>
                            ...
                            <div class="checkout-items-wrapper">
                                ...
                                <div class="sub-total-wrap">
                                    ...
                                    <div class="sub-total-item grand-total">
                                         ...
                                         <input type="hidden" name="grandTotalInput" id="grandTotalInput" value="{{$cartTotal}}">
                                    </div>
                                </div>
