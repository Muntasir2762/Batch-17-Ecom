		...
		<section class="product-section">
			<div class="container">
				<div class="section-title-outer">
					...
					<a href="{{url('/view-type-products/hot')}}" class="product-view-all-btn">
						View All
					</a>
				</div>
		...
		<section class="product-section">
			<div class="container">
				<div class="section-title-outer">
					...
					<a href="{{url('/view-type-products/new')}}" class="product-view-all-btn">
						View All
					</a>
				</div>
				<div class="product-items-wrapper">
		...
		<section class="product-section">
			<div class="container">
				<div class="section-title-outer">
					...
					<a href="{{url('/view-type-products/regular')}}" class="product-view-all-btn">
						View All
					</a>
				</div>
				<div class="product-items-wrapper">
		...
		<section class="product-section">
			<div class="container">
				<div class="section-title-outer">
					...
					<a href="{{url('/view-type-products/discount')}}" class="product-view-all-btn">
						View All
					</a>
				</div>
				<div class="product-items-wrapper">
