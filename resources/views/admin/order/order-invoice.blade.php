...
<body>
    <div style="display: flex;align-items: center;justify-content: space-between;margin-bottom: 25px">
        <div style="width: 35%">
            <img src="{{asset('admin/settings/'.$siteSettings->logo)}}" style="max-height: 100px; width: 100px;" alt="logo" />
        </div>
        <div style="width: 65%">
    ...
    <div style="display: flex;justify-content: space-between;">
        ...
        <div style="width: 33.33%;margin-top: 30px;">
            ...
            <p style="font-size: 18px; margin-bottom:2px"><b>Order Date: {{$order->created_at}}</b></p>
    ...
    <table class="invoice-table" style="margin-bottom: 0px; border: 1px solid #000;width: 100%;margin-top: 15px;">
        ...
        <tr>
            ...
            <td style="width: 20%;">Size: {{$details->size}}</td>
            <td style="width: 20%;">Color: {{$details->color}}</td>
        </tr>
        @endforeach
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td><strong>{{$subTotal+$order->charge}} Tk.</strong></td>
        </tr>
    </table>
    <!-- /Header -->
    <hr>
